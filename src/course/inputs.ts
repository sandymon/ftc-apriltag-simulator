export const inputs = [
  ...
  { id: "exposure", label: "Exposure", group: "Input", unit: "ms in this lab", meaning: "The time the sensor collects light for each frame. Short exposures reduce motion blur but darken the image.", effect: "Lower exposure until the image loses contrast, then recover detection.", mistake: "The historical UI uses 0.01 ms increments. Always check your installed UI unit.", source: "pipeline" },
  ...
  { id: "quality", label: "Quality threshold", group: "Configuration", unit: "Version dependent", meaning: "A quality setting rejects weak candidates. Its exact score, direction, and range must be read from the installed LimelightOS version.", effect: "The lab offers a separate illustrative minimum-confidence control, not a reproduction of that undocumented score.", mistake: "Do not transfer the reference deck's threshold value or direction without verification.", source: "deck" },
